...
Este arquivo organiza a evolucao funcional da branch `release/sprint-2` por sprint. O foco aqui e registrar o que entrou na entrega, como essas partes foram implementadas e por que cada bloco foi importante para transformar o prototipo em uma versao mais completa do produto.
